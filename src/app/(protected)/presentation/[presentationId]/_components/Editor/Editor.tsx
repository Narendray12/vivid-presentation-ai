...
interface DraggablesSlideProps {
  slide: Slide;
  index: number;
...
export const DraggableSlide: React.FC<DraggablesSlideProps> = ({
  slide,
  index,
  moveSlide,
  handleDelete,
...
const Editor = ({ isEditable }: Props) => {
  ...
  return (
    <div className="flex-l flex flex-col h-full max-w-3xl mx-auto px-4 mb-20">
      {loading ? (
        ...
        <ScrollArea className="flex-l mt-8">
